...
<img src="./img/rootfiber.png" alt="rootFiber">
...
<img src="./img/workInProgressFiber.png" alt="workInProgressFiber">
...
<img src="./img/wipTreeFinish.png" alt="workInProgressFiberFinish">

## update时

1. 接下来我们点击`p节点`触发状态改变，这会开启一次新的`render阶段`并构建一棵新的`workInProgress Fiber 树`。

<img src="./img/wipTreeUpdate.png" alt="wipTreeUpdate">
...
<img src="./img/currentTreeUpdate.png" alt="currentTreeUpdate">
